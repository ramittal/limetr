...
! BLOCK_LSVD compute the svd of a matrix and output the singular value and the left
! singular vector
! -----------------------------------------------------------------------------
SUBROUTINE BLOCK_LSVD(sz1, sz2, su, ss, z, u, s)
    IMPLICIT NONE
...
END SUBROUTINE BLOCK_LSVD


! LSVD compute the svd of the block of Z matrix
! -----------------------------------------------------------------------------
SUBROUTINE LSVD(sz1, sz2, su, ss, m, nz, nu, ns, z, u, s)
    IMPLICIT NONE
    ...
    DO i = 1, m
        ...
        CALL BLOCK_LSVD(nz(i), sz2, nu(i), ns(i), z(az:bz, :), u(au:bu), s(as:bs))
